...
const HANDLER_PROPERTIES = {
    apiVersion: types_1.ShopifyHeader.ApiVersion,
    domain: types_1.ShopifyHeader.Domain,
    hmac: types_1.ShopifyHeader.Hmac,
    topic: types_1.ShopifyHeader.Topic,
    webhookId: types_1.ShopifyHeader.WebhookId,
};
